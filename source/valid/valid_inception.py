...
os.chdir('/Users/xky/PycharmProjects/weapon')
_BATCH_SIZE = 1
...
pred_labels=tf.argmax(rar_probs, 1)
...
if __name__ == '__main__':
    ...
    img_path='data/valid/0001.jpg'
    imgs=[]
    imgs.append(load_img(img_path))
    pred_label = sess.run(pred_labels, feed_dict={X: imgs})
    print(pred_label)